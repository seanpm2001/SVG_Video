...
class Ubuntu2010_SVGVideoPlayer {
  ...
  int main() {
    ...
    supportUID = str("Ubuntu 20.10 64 bit"); // Operating system name and version
    supportSYS = str("Debian 9"); // Base distribution name and version
    supportKRN = str("Linux 5.8"); // Kernel name and version
    ...
    merge();
    std::cout << "Ubuntu 20.10 support is coming soon";
    }
// Divider between main and class
}
/* File info
* File type: C++ Source file (*.cpp, *.cxx)
* File version: 1 (Saturday, April 24th 2021 at 8:54 pm)
