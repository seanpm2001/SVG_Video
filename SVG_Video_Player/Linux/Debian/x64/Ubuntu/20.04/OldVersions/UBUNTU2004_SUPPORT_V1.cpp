...
#include <vector>
#include <stdexcept>
// Support script for Ubuntu 20.04
// The last file (DEBIAN10_SUPPORT.cpp) was written very poorly. I wrote this file a bit better.
// Please note that I am not experienced with C++ so this file may not be functional and may come off as bad code
class Ubuntu2004_SVGVideoPlayer {
  int merge() {
  ...
  int main() {
    // get.stream(deb64) // Need better syntax that actually works
    supportUID = str("Ubuntu 20.04 64 bit"); // Operating system name and version
    supportSYS = str("Debian 9"); // Base distribution name and version
    supportKRN = str("Linux 5.4"); // Kernel name and version
    integerTypeBase = int(64);
    ...
    merge();
    std::cout << "Ubuntu 20.04 support is coming soon";
    }
// Divider between main and class
}
/* File info
* File type: C++ Source file (*.cpp, *.cxx)
* File version: 1 (Saturday, April 24th 2021 at 8:47 pm)
